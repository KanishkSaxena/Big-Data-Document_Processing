...
public class AssessedExercise {
	...
	public static void main(String[] args) throws IOException {
		...
		SparkConf conf = new SparkConf().setMaster(sparkMasterDef).setAppName(sparkSessionName).set("spark.driver.maxResultSize", "4g").set("spark.network.timeout","400001").set("spark.executor.heartbeatInterval", "400000");
